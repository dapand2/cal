...
public class MainActivity extends Activity  {
	...
	private void saveeventdata2() {
		...
		text2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				/*datab = new database(getBaseContext());
				datab.open();
				long id = datab.insertdata(begin2, end2);
				Toast.makeText(getBaseContext(), "inserted", Toast.LENGTH_LONG)
						.show();
								datab.close();*/
			}
	...
	private void getCalendars() {
	    ...
	    private void getLastThreeEvents() {
	    	...
	    	Cursor l_managedCursor = this.managedQuery(builder.build(), l_projection, "calendar_id=" + m_selectedCalendarId, null, "dtstart ASC, dtend DESC");
